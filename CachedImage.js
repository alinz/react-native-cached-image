...
const CachedImage = React.createClass({
  propTypes: {
    ...
    useQueryParamsInCacheKey: React.PropTypes.oneOfType([React.PropTypes.bool, React.PropTypes.array])
      .isRequired,
  ...
  renderLoader() {
    ...
    return this.props.renderImage({
      ...
      key: source.uri,
      source,
      children: <ActivityIndicator {...activityIndicatorProps} style={activityIndicatorStyle} />
    })
  }
})
